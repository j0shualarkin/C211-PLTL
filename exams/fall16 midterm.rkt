...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |fall16 midterm|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (correct-food? a f)
  (cond
    [(string=? (animal-id a) "horse")  (string=? (food-id f) "oats")]
    [(string=? (animal-id a) "chicken") (string=? (food-id f) "worms")]
    [(string=? (animal-id a) "monkey") (string=? (food-id f) "banana")]
    [else #t]))
